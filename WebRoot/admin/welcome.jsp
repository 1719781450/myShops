...
<form name="Form1" method="post" action="name.aspx" id="Form1">
	...
	<table width="100%" border="0" height="88" border="1">
		<tr>
			<td colspan=3 class="ta_01" align="center" bgcolor="#afd1f3" style="background-color:#30A1CA;"><strong style="font-size:16px;">我的@商城管理中心</strong></td>
		</tr>

		<tr>
			<td width="65%" height="84" align="center" valign="top" >
				<span class="Style1">欢迎登陆本系统</span>
			</td>
		</tr>
