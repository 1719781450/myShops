				...
				<TBODY>
					<tr>
						<td class="ta_01" align="center" bgColor="#afd1f3">
							<strong style="font-size:16px;">商品详细列表</strong>
						</TD>
					</tr>
					<tr>
						<td class="ta_01" align="right">
							<button type="button" id="add" name="add" value="添加" class="button small round red" onclick="addProduct()">
添加
</button>
					...
					<tr align="center">
						...
						<div style="display:none;">
							...
							<s:if test="pageBean.page != 1">
								<a id="firstPag" href="${ pageContext.request.contextPath }/adminProduct_findAll.action?page=1">首页</a>|
								<a id="prePag" href="${ pageContext.request.contextPath }/adminProduct_findAll.action?page=<s:property value="pageBean.page-1"/>">上一页</a>|
							</s:if>
							<s:if test="pageBean.page != pageBean.totalPage">
								<a id="nextPag" href="${ pageContext.request.contextPath }/adminProduct_findAll.action?page=<s:property value="pageBean.page+1"/>">下一页</a>|
								<a id="lastPag" href="${ pageContext.request.contextPath }/adminProduct_findAll.action?page=<s:property value="pageBean.totalPage"/>">尾页</a>|
							</s:if>
								</div>
