...
<div class="headerAd">
			...
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<input type="submit" class="button orange medium rounded"
										value="同意以下协议并注册">
									</td>
								</tr>
								<tr>
						...
						<div class="login">
						   <div>
						     <img src="${pageContext.request.contextPath}/img/get.jpg">
						   </div>
							<div class="ad">
								<dl>
									<dt>绝对正品,我们承诺：</dt>
							...
							<div style="margin-left: -20px;">
						     <img src="${pageContext.request.contextPath}/img/pp.jpg">
						 </div>
						</div>
	...
	<div style="width:100%;background-color:#000;border:8px solid #000;"></div>
 <!--  footter部分	 -->
