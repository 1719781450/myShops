...
<div class="headerAd">
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span24">
			<div class="step step1">
				<span style="color:#ffffff;line-height:38px;margin-left:50px;">购物车信息</span>
			</div>
				<table>
					<tbody>
					<tr>
 ...
 <div style="width: 100%;background-color: #0C0C0C;position: fixed; bottom: 0px;">	
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2005-2015 我的@商城 版权所有</div>
	</div>
</div>
</div>
</body></html>