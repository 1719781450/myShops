...
public class UserAdminAction extends ActionSupport implements ModelDriven<User>{
	...
	private String sussMeg;//接受信息 

	public void setSussMeg(String sussMeg) {
		this.sussMeg = sussMeg;
	}
	...
	public String findAll(){
		...
		ActionContext.getContext().getValueStack().set("pageBean", pageBean);//存入值占中
		return "findAll";
	}
