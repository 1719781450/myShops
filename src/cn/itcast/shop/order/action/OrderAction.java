...
public class OrderAction extends ActionSupport implements ModelDriven<Order> {
	...
	public String saveOrder() {
		...
		if (existUser == null) {
			this.addActionMessage("亲!您还没有登录,赶紧去登陆吧！");
			return "msg";
		}
	...
	public String payOrder() throws IOException {
		...
		String p8_Url = "${ pageContext.request.contextPath }/sucGou.html"; // 商户接收支付成功数据的地址:   跳转到支付成功的页面
		...
		StringBuffer sb = new StringBuffer("sucGou.html");
